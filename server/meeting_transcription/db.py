...
from sqlalchemy import MetaData, create_engine as sqlalchemy_create_engine
...
def create_engine(database_url: str, *, echo: bool = False) -> Engine:
    ...
    return sqlalchemy_create_engine(database_url, echo=echo, connect_args=connect_args)
